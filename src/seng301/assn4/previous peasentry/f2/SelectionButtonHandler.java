...
public class SelectionButtonHandler implements SelectionButtonListener, HardwareLogic{
    ...
    public SelectionButtonHandler(HardwareFacade hardwareFacade){
    	hf = hardwareFacade;
    	registerWith(hf);
    }
	...
	public void pressed(SelectionButton button) {
		...
		int cost = hf.getPopKindCost(index);
	...
	@Override
	public void registerWith(HardwareFacade hf) {
