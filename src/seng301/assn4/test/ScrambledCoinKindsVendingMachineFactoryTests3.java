...
public class ScrambledCoinKindsVendingMachineFactoryTests3 {
    private HardwareFacade hf;

    @Before
    public void setup() {
	VendingMachine vm = new VendingMachine(new Cents[] {new Cents(100), new Cents(5), new Cents(25), new Cents(10)}, 3, 2, 10, 10);
	hf = vm.getHardware();
	...
	assertEquals(215, Utilities.extractAndSumFromCoinRacks(hf));
	assertEquals(100, Utilities.extractAndSumFromStorageBin(hf));
